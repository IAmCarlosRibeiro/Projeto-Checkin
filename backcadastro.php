...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password == $confirmpassword) {
        ...
        if (!$db) {
            ...
            header("Location:cadastro.php?message=2");
        }
        ...
        if ($db->exec($sql)) {
            ...
            header("Location:cadastro.php?message=1");
        } else {
            //echo "Erro ao cadastrar. Tente novamente.";
            header("Location:cadastro.php?message=4");
        }
        ...
        header("Location:cadastro.php?message=3");
    }
}
?>